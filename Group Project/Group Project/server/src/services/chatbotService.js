...
export const getChatbotReply = async (message) => {
  ...
  try {
    ...
    const aiStatusMessage = isInvalidKey
      ? "Gemini API key is invalid, so this answer is using local issue analytics instead."
      : "Gemini is unavailable right now, so this answer is using local issue analytics instead.";
